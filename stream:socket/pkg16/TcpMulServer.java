...
class ServerClass {
    ...
    ArrayList<ServerClass.ThreadServerClass> threadList = new ArrayList<ServerClass.ThreadServerClass>();
    ...
    public ServerClass(int portno) throws IOException {
        ...
        while (true) {
            ...
            ServerClass.ThreadServerClass threadServerClass = new ServerClass.ThreadServerClass(s1); // s1 초기치
